...
const Lab8bai1 = (props) => {
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ThongTin', { navigation: navigation, user: item })}>
            ...
            <View style={styles.itemContainer}>
                ...
                <View style={styles.bottom}>
                    <TouchableOpacity style={styles.edit} onPress={() => navigation.navigate('SuaThongTin', { user: item, navigation: navigation })}>
    ...
    return (
        <View style={styles.container}>
            <TouchableOpacity style={styles.btnAddContainer} onPress={() => navigation.navigate('SuaThongTin', { navigation: navigation, user: null })}>
